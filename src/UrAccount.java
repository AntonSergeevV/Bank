public class UrAccount implements Client {
    ...
    public double moneyFromAccount(double amount) {
        if (balance < amount) {
            ...
            balance = balance - (amount + (amount * x));
            System.out.println(balance);
    ...
    public UrAccount(Builder builder) {
    ...
    public static class Builder {
        ...
        public UrAccount build() {
            return new UrAccount(this);
        }
